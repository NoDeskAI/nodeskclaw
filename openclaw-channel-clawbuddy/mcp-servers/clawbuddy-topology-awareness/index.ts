...
/**
 * ClawBuddy Topology Awareness MCP Server
...
const API = process.env.CLAWBUDDY_API_URL || "http://localhost:8000/api/v1";
const TOKEN = process.env.CLAWBUDDY_TOKEN || "";
const WORKSPACE_ID = process.env.CLAWBUDDY_WORKSPACE_ID || "";
...
const server = new Server({ name: "clawbuddy-topology-awareness", version: "1.0.0" }, { capabilities: { tools: {} } });
