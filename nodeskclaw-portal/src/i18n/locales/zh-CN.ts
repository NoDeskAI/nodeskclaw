const zhCN = {
  ...
  addAgentView: {
    title: "添加 Agent",
    subtitle: "从已有实例中选择一个 Agent 添加到工作区，或创建新实例",
    createNew: "创建新实例",
    createNewDesc: "部署一个全新的 DeskClaw 实例",
    searchPlaceholder: "搜索实例...",
    refresh: "刷新列表",
    noInstances: "没有可用的实例",
    alreadyInWorkspace: "已在当前工作区",
    unavailableHint: "以下实例尚未就绪，无法添加到工作区",
    added: "已添加",
    unavailable: "不可用",
    addBtn: "添加",
    ...
    geneDialogBody: "该 Agent 尚未安装拓扑感知基因，无法感知工作区中的周围拓扑和连接关系。安装后实例将重启以加载新能力。",
  ...
  instanceList: {
    title: "实例管理",
    subtitle: "管理已部署的 DeskClaw 实例",
    refresh: "刷新",
    createInstance: "创建实例",
    loadFailed: "加载实例列表失败",
    retry: "重试",
    emptyTitle: "还没有实例",
    emptyDescription: "创建一个 DeskClaw 实例，部署到 Kubernetes 集群",
    createFirst: "创建第一个实例",
    tableName: "名称",
    tableStatus: "状态",
  ...
  channel: {
    ...
    restartTimeout: "配置已保存，但 DeskClaw 重启超时，请检查实例状态",
    saved: "配置已保存",
    saveFailed: "保存失败",
  ...
  agentDetailDialog: {
    ...
    restart: "重启实例",
    restarting: "重启中...",
    restartConfirmTitle: "重启实例",
    restartConfirmDesc: "即将重启实例，重启期间服务将短暂不可用，正在进行的对话和任务会被中断。",
    deleteConfirmTitle: "删除实例",
    deleteConfirmDesc: "确定删除实例「{name}」？实例及其 K8s 资源将被永久删除，此操作不可恢复。",
    loadFailed: "加载失败",
    restartDone: "重启完成，实例已恢复运行",
