const enUS = {
  ...
  instanceGenes: {
    ...
    podUnavailable: "Instance unavailable, cannot load gene list",
    ...
    forgetWarning1: "The agent will enter deep forgetting, reviewing usage experience and producing a forget summary. The agent may choose to fully forget or simplify while retaining core cognition.",
    forgetWarning2: "The instance will automatically restart after forgetting.",
  ...
  workspaceSettings: {
    ...
    perm_delete_workspace: "Delete Workspace",
  },
  blackboard: {
  ...
  addAgentView: {
    title: "Add Agent",
    subtitle: "Select an existing instance to add to the workspace, or create a new one",
    createNew: "Create New Instance",
    createNewDesc: "Deploy a brand new DeskClaw instance",
    searchPlaceholder: "Search instances...",
    refresh: "Refresh list",
    noInstances: "No instances available",
    alreadyInWorkspace: "Already in this workspace",
    unavailableHint: "The following instances are not ready and cannot be added",
    added: "Added",
    unavailable: "Unavailable",
    addBtn: "Add",
    addedToast: "Agent has been added to the workspace",
    goToView: "Go to view",
    addFailed: "Failed to add",
    stepCheckGene: "Checking genes...",
    stepConfiguring: "Configuring...",
    stepDeployPlugin: "Deploying plugin...",
    stepRestarting: "Restarting instance...",
    stepConnecting: "Connecting...",
    geneDialogTitle: "Topology Awareness Gene Required",
    geneDialogBody: "This Agent does not have the topology awareness gene installed. It cannot perceive surrounding topology and connections in the workspace. The instance will restart after installation.",
  ...
  instanceList: {
    ...
    subtitle: "Manage deployed DeskClaw instances",
    refresh: "Refresh",
    createInstance: "Create Instance",
    loadFailed: "Failed to load instances",
    retry: "Retry",
    emptyTitle: "No instances yet",
    emptyDescription: "Create a DeskClaw instance and deploy it to a Kubernetes cluster",
  ...
  channel: {
    ...
    restartTimeout: "Config saved, but DeskClaw restart timed out, please check instance status",
    saved: "Config saved",
    saveFailed: "Failed to save",
  ...
  agentDetailDialog: {
    ...
    restarting: "Restarting...",
    restartConfirmTitle: "Restart Instance",
    restartConfirmDesc: "The instance will be restarted. Services will be briefly unavailable, and ongoing conversations and tasks will be interrupted.",
    deleteConfirmTitle: "Delete Instance",
    deleteConfirmDesc: "Delete instance \"{name}\"? The instance and its K8s resources will be permanently removed. This action cannot be undone.",
    loadFailed: "Failed to load",
    restartDone: "Restart complete, instance is running again",
