...
from app.models.agent_device import AgentDeviceLease
...
async def _place_available_device(monkeypatch: pytest.MonkeyPatch, db: AsyncSession, workspace: Workspace, user: User):
